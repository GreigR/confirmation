...
Borrowed from the physical sciences, entropy (H) in this context determines the amount of "organised" information in a given system (S) [@shannon1949mathematical, p. 12]. It is the combination of each index code, together with how likely it is to occur.
